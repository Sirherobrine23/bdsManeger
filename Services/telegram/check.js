module.exports.checkUser = (USERNAME) => {
    const fs = require('fs')
    if (fs.existsSync(`${require('bds_maneger_api').server_dir}/telegram_admin.json`)) {
        var admins = fs.readFileSync(`${require('bds_maneger_api').server_dir}/telegram_admin.json`, 'utf-8');
    } else {
